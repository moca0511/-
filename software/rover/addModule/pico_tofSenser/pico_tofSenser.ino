...
#define FRONT_SENSER1 0
#define FRONT_SENSER2 1
#define POST_SENSER1 2
#define POST_SENSER2 3
#define RIGHT_SENSER 4
#define LEFT_SENSER 5
...
void loop()
{
  ...
  Serial.print(" result:");
  for (int i = 0; i < WALL_FLG_COUNT; i++) {
    Serial.print(wallFlg[i]);
    Serial.print(", ");
  }
  Serial.println("  ");
  delay(100);
