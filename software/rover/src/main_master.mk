...
SOURCE_SUB_PATH=${SOURCE_SUB:%=${FILE_DIR}%}
HEADER_PATH=${SOURCE_SUB_PATH:%.cpp=%.h}
...
# プログラムの生成ルール
$(PROGRAM_PATH): $(SOURCE_PATH) ${LIBS_PATH} ${SOURCE_SUB_PATH} ${HEADER_PATH}
	$(CC) -o $(PROGRAM_PATH) $(SOURCE_PATH) ${SOURCE_SUB_PATH} -I${INCLUDE_DIR} -L${LIB_LIB_DIR}	${LIBS} ${E_LIB}
